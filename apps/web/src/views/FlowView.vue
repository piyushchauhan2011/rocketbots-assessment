...
import {
  ...
  spliceNodes,
} from '@rocketbots/core'
import { Button } from '@rocketbots/ui/button'
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@rocketbots/ui/card'
...
/** @typedef {import('@rocketbots/core/types').NodeDraft} NodeDraft */
/** @typedef {import('@rocketbots/core/types').FlowNodeCommand} FlowNodeCommand */
